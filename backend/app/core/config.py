...
class Settings:
    ...
    REDIS_MAX_CONNECTIONS_RATE_LIMIT: int = int(os.getenv("REDIS_MAX_CONNECTIONS_RATE_LIMIT", "5"))
    REDIS_MAX_CONNECTIONS_AI_CACHE: int = int(os.getenv("REDIS_MAX_CONNECTIONS_AI_CACHE", "5"))
    REDIS_MAX_CONNECTIONS_HEALTHCHECK: int = int(os.getenv("REDIS_MAX_CONNECTIONS_HEALTHCHECK", "2"))
    REDIS_MAX_CONNECTIONS_DEFAULT: int = int(os.getenv("REDIS_MAX_CONNECTIONS_DEFAULT", "5"))
