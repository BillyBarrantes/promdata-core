...
class Settings:
    ...
    CELERY_TASK_SOFT_TIME_LIMIT: int = int(os.getenv("CELERY_TASK_SOFT_TIME_LIMIT", "180"))
    CELERY_TASK_HARD_TIME_LIMIT: int = int(os.getenv("CELERY_TASK_HARD_TIME_LIMIT", "240"))
    ...
    GEMINI_CIRCUIT_FAILURE_THRESHOLD: int = int(os.getenv("GEMINI_CIRCUIT_FAILURE_THRESHOLD", "5"))
    GEMINI_CIRCUIT_RECOVERY_TIMEOUT_SECONDS: int = int(os.getenv("GEMINI_CIRCUIT_RECOVERY_TIMEOUT_SECONDS", "30"))
    GEMINI_CIRCUIT_HALF_OPEN_MAX_CALLS: int = int(os.getenv("GEMINI_CIRCUIT_HALF_OPEN_MAX_CALLS", "1"))
