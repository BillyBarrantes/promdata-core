...
class Settings:
    ...
    REDIS_MAX_CONNECTIONS_RATE_LIMIT: int = int(os.getenv("REDIS_MAX_CONNECTIONS_RATE_LIMIT", "30"))
    REDIS_MAX_CONNECTIONS_AI_CACHE: int = int(os.getenv("REDIS_MAX_CONNECTIONS_AI_CACHE", "30"))
    REDIS_MAX_CONNECTIONS_HEALTHCHECK: int = int(os.getenv("REDIS_MAX_CONNECTIONS_HEALTHCHECK", "10"))
    REDIS_MAX_CONNECTIONS_DEFAULT: int = int(os.getenv("REDIS_MAX_CONNECTIONS_DEFAULT", "20"))
    CELERY_BROKER_POOL_LIMIT: int = int(os.getenv("CELERY_BROKER_POOL_LIMIT", "30"))
    CELERY_RESULT_BACKEND_MAX_CONNECTIONS: int = int(
        os.getenv("CELERY_RESULT_BACKEND_MAX_CONNECTIONS", "30")
    )
