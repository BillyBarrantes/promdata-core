...
def test_levels():
    ...
    if plan_basic:
        print(f"   👉 Resultado: {plan_basic[0].main_intent.visual_protocol.value}")
        print(f"   🧠 Rationale: {plan_basic[0].main_intent.rationale}")
    ...
    if plan_advanced:
        print(f"   👉 Resultado: {plan_advanced[0].main_intent.visual_protocol.value}")
    ...
    if plan_box:
        print(f"   👉 Resultado: {plan_box[0].main_intent.visual_protocol.value}")
    ...
    if plan_funnel:
        print(f"   👉 Resultado: {plan_funnel[0].main_intent.visual_protocol.value}")
